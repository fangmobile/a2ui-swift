...
public enum ComponentType_V09: Hashable {
    ...
    /// Map from raw type name string to `ComponentType_V09`.
    public static func from(_ typeName: String) -> ComponentType_V09 {
        switch typeName {
...
public enum TextVariant_V09: Codable, Hashable {
...
/// Image fit mode.
public enum ImageFit_V09: Codable, Hashable {
...
/// Image variant.
public enum ImageVariant_V09: Codable, Hashable {
...
public enum Justify_V09: Codable, Hashable {
...
public enum Align_V09: Codable, Hashable {
...
/// List direction.
public enum ListDirection_V09: Codable, Hashable {
...
/// Divider axis.
public enum DividerAxis_V09: Codable, Hashable {
...
/// Button variant.
public enum ButtonVariant_V09_Enum: Codable, Hashable {
...
/// TextField variant.
public enum TextFieldVariant_V09: Codable, Hashable {
...
public enum ChoicePickerVariant_V09: Codable, Hashable {
...
public enum ChoicePickerDisplayStyle_V09: Codable, Hashable {
    case checkbox, chips
    case unknown(String)
...
public struct TextProperties_V09: Codable {
    public var text: DynamicString_V09
    public var variant: TextVariant_V09?
}

public struct ImageProperties_V09: Codable {
    public var url: DynamicString_V09
    public var fit: ImageFit_V09?
    public var variant: ImageVariant_V09?
}

public struct IconProperties_V09: Codable {
    public var name: IconNameValue_V09
}

/// v0.9 Icon.name: either an enum string or `{"path":"M10 20..."}` for custom SVG.
public enum IconNameValue_V09: Codable {
    case standard(DynamicString_V09)
        ...
        case .dictionary(let dict):
            if dict.count == 1,
               ...
               Self.looksLikeSVGPath(pathStr) {
                ...
                let ds = try JSONDecoder().decode(DynamicString_V09.self, from: data)
                self = .standard(ds)
            }
        default:
...
public struct VideoProperties_V09: Codable {
    public var url: DynamicString_V09
}

public struct AudioPlayerProperties_V09: Codable {
    public var url: DynamicString_V09
...
public struct RowProperties_V09: Codable {
    public var children: ChildList_V09
    public var justify: Justify_V09?
    public var align: Align_V09?
}

public struct ColumnProperties_V09: Codable {
    public var children: ChildList_V09
    public var justify: Justify_V09?
    public var align: Align_V09?
}

public struct ListProperties_V09: Codable {
    public var children: ChildList_V09
    public var direction: ListDirection_V09?
    public var align: Align_V09?
}

public struct CardProperties_V09: Codable {
    public var child: String
}

public struct TabItemEntry_V09: Codable {
    public var title: DynamicString_V09
    public var child: String
}

public struct TabsProperties_V09: Codable {
    public var tabs: [TabItemEntry_V09]
}

public struct ModalProperties_V09: Codable {
    public var trigger: String
    public var content: String
}

public struct DividerProperties_V09: Codable {
    public var axis: DividerAxis_V09?
}

// MARK: - Interactive & Input

public struct ButtonProperties_V09: Codable {
    public var child: String
    public var action: Action_V09
    public var variant: ButtonVariant_V09_Enum?
    public var checks: [CheckRule_V09]?
}

public struct TextFieldProperties_V09: Codable {
    public var label: DynamicString_V09
    public var value: DynamicString_V09?
    public var variant: TextFieldVariant_V09?
    public var validationRegexp: String?
    public var checks: [CheckRule_V09]?
}

public struct CheckBoxProperties_V09: Codable {
    public var label: DynamicString_V09
    public var value: DynamicBoolean_V09
    public var checks: [CheckRule_V09]?
}

public struct SliderProperties_V09: Codable {
    public var label: DynamicString_V09?
    public var value: DynamicNumber_V09
    public var min: Double?
    public var max: Double?
    public var checks: [CheckRule_V09]?
}

public struct DateTimeInputProperties_V09: Codable {
    public var value: DynamicString_V09
    public var enableDate: Bool?
    public var enableTime: Bool?
    public var min: DynamicString_V09?
    public var max: DynamicString_V09?
    public var label: DynamicString_V09?
    public var checks: [CheckRule_V09]?
}

public struct ChoicePickerOption_V09: Codable {
    public var label: DynamicString_V09
    public var value: String
}

public struct ChoicePickerProperties_V09: Codable {
    public var label: DynamicString_V09?
    public var variant: ChoicePickerVariant_V09?
    public var options: [ChoicePickerOption_V09]?
    public var value: DynamicStringList_V09?
    public var displayStyle: ChoicePickerDisplayStyle_V09?
